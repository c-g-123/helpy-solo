...
def calendar(request):
    return render(request, 'core/aggregation/pages/calendar.html')
...
def agenda(request):
    ...
    return render(request, 'core/aggregation/pages/agenda.html', {'tasks': tasks})


@login_required
def kanban(request):
    return render(request, 'core/aggregation/pages/kanban.html')